...
namespace NumerosExtensosTests
{
    public class ExtensoCardinalTests
    {
        ...
        public static IEnumerable<object[]> InstanciaParaEscreverValorCardinalCorretamente => new List<object[]>
        {
            ...
            new object[] { "0.1031", "ZERO VÍRGULA MIL E TRINTA E UM" },
            new object[] { "3", "TRÊS" },
            ...
            new object[] { "1500", "MIL E QUINHENTOS" },
            new object[] { "1354.44", "MIL, TREZENTOS E CINQUENTA E QUATRO VÍRGULA QUARENTA E QUATRO" },
            ...
            new object[] { "12001006.99", "DOZE MILHÕES, MIL E SEIS VÍRGULA NOVENTA E NOVE" },
            ...
            new object[] { "99001001000.1", "NOVENTA E NOVE BILHÕES, UM MILHÃO, MIL VÍRGULA UM" },
            ...
            new object[] { "855000100001100.89", "OITOCENTOS E CINQUENTA E CINCO TRILHÕES, CEM MILHÕES, MIL E CEM VÍRGULA OITENTA E NOVE" }
        };
