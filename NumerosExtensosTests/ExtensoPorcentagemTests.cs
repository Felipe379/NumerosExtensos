...
namespace NumerosExtensosTests
{
    public class ExtensoPorcentagemTests
    {
        ...
        public static IEnumerable<object[]> InstanciaParaEscreverValorPorcentagemCorretamente => new List<object[]>
        {
            ...
            new object[] { "0.1031", "ZERO VÍRGULA MIL E TRINTA E UM POR CENTO" },
            ...
            new object[] { "1500", "MIL E QUINHENTOS POR CENTO" },
            new object[] { "1354.44", "MIL TREZENTOS E CINQUENTA E QUATRO VÍRGULA QUARENTA E QUATRO POR CENTO" },
            ...
            new object[] { "12001006.99", "DOZE MILHÕES MIL E SEIS VÍRGULA NOVENTA E NOVE POR CENTO" },
            ...
            new object[] { "99001001000.1", "NOVENTA E NOVE BILHÕES UM MILHÃO MIL VÍRGULA UM POR CENTO" },
            ...
            new object[] { "855000100001100.89", "OITOCENTOS E CINQUENTA E CINCO TRILHÕES CEM MILHÕES MIL E CEM VÍRGULA OITENTA E NOVE POR CENTO" }
        };
        ...
        {
            var actual = _extenso.Escrever(OpcoesPredefinidas.Predefinicoes[Predefinicoes.Porcentagem]).Numero(valor).ToUpper();
