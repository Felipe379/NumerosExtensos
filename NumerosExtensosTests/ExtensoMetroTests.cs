...
namespace NumerosExtensosTests
{
    public class ExtensoMetroTests
    {
        ...
        public static IEnumerable<object[]> InstanciaParaEscreverValorPorcentagemCorretamente => new List<object[]>
        {
            ...
            new object[] { "0.1031", "ZERO VÍRGULA MIL E TRINTA E UM METRO" },
            ...
            new object[] { "1354.44", "MIL TREZENTOS E CINQUENTA E QUATRO VÍRGULA QUARENTA E QUATRO METROS" },
            ...
            new object[] { "12001006.99", "DOZE MILHÕES MIL E SEIS VÍRGULA NOVENTA E NOVE METROS" },
            ...
            new object[] { "99001001000.1", "NOVENTA E NOVE BILHÕES UM MILHÃO MIL VÍRGULA UM METROS" },
            ...
            new object[] { "855000100001100.89", "OITOCENTOS E CINQUENTA E CINCO TRILHÕES CEM MILHÕES MIL E CEM VÍRGULA OITENTA E NOVE METROS" }
        };
